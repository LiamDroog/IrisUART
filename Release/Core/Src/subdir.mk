...
Core/Src/%.o Core/Src/%.su: ../Core/Src/%.c Core/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m0plus -std=gnu11 -DUSE_HAL_DRIVER -DSTM32L071xx -c -I../Core/Inc -I../Drivers/CMSIS/Include -I../Drivers/STM32L0xx_HAL_Driver/Inc -I../Drivers/CMSIS/Device/ST/STM32L0xx/Include -I../Drivers/STM32L0xx_HAL_Driver/Inc/Legacy -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"

clean: clean-Core-2f-Src

clean-Core-2f-Src:
	-$(RM) ./Core/Src/I2C.d ./Core/Src/I2C.o ./Core/Src/I2C.su ./Core/Src/IEB_TESTS.d ./Core/Src/IEB_TESTS.o ./Core/Src/IEB_TESTS.su ./Core/Src/INA231.d ./Core/Src/INA231.o ./Core/Src/INA231.su ./Core/Src/arducam.d ./Core/Src/arducam.o ./Core/Src/arducam.su ./Core/Src/cli.d ./Core/Src/cli.o ./Core/Src/cli.su ./Core/Src/housekeeping.d ./Core/Src/housekeeping.o ./Core/Src/housekeeping.su ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/nand_m79a.d ./Core/Src/nand_m79a.o ./Core/Src/nand_m79a.su ./Core/Src/nand_m79a_lld.d ./Core/Src/nand_m79a_lld.o ./Core/Src/nand_m79a_lld.su ./Core/Src/nand_spi.d ./Core/Src/nand_spi.o ./Core/Src/nand_spi.su ./Core/Src/printf.d ./Core/Src/printf.o ./Core/Src/printf.su ./Core/Src/spi_bitbang.d ./Core/Src/spi_bitbang.o ./Core/Src/spi_bitbang.su ./Core/Src/stm32l0xx_hal_msp.d ./Core/Src/stm32l0xx_hal_msp.o ./Core/Src/stm32l0xx_hal_msp.su ./Core/Src/stm32l0xx_it.d ./Core/Src/stm32l0xx_it.o ./Core/Src/stm32l0xx_it.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32l0xx.d ./Core/Src/system_stm32l0xx.o ./Core/Src/system_stm32l0xx.su ./Core/Src/tmp421.d ./Core/Src/tmp421.o ./Core/Src/tmp421.su
